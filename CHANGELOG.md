...
- **Config commands** - `fog config view|set` for combined config visibility and Fog setting updates
- **Installer update** - `scripts/install.sh` now installs `wtx`, `fog`, and `fogd`
